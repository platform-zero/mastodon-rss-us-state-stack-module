# Mastodon RSS United States State stack module

Content-only Platform Zero module providing curated United States public-media feeds and Mastodon bootstrap follows to `mastodon-rss-publisher`.
